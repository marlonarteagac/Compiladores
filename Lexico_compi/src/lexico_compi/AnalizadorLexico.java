...
public class AnalizadorLexico {
    ...
    public static void main(String[] args) {
        ...
        if (texto.length() < 20) {
            System.out.println("" + validarLongitudTexto(texto));
            if (texto.isEmpty()) {
                ...
                for (int i = contador - 1; i > 0; i--) {// INICIO DEL FOR PRINCIPAL
                    ...
                    if (variable.length <= 5) {
                        System.out.println("tamaño valido " + mv);
                    } else {
                        System.out.println("variable invalida " + mv);
                        break;
                    }
    ...
    public static String validarLongitudTexto(String texto) {
        ...
        if (longitudActual > longitudMaxima) {
            ...
            return "Texto válido. Te quedan " + caracteresRestantes + " caracteres de los " + longitudMaxima
                    + " disponibles.";
        }
    }
